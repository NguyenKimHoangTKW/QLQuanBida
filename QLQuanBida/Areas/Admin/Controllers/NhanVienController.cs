...
namespace QLQuanBida.Areas.Admin.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idNV,MaNV,TenNV,DiaChi,DienThoai,NgaySinh,MoTa,userName,passWord,NgayTao")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idNV,MaNV,TenNV,DiaChi,DienThoai,NgaySinh,MoTa,userName,passWord,NgayTao")] NhanVien nhanVien)
        {
            if (ModelState.IsValid)
            {
